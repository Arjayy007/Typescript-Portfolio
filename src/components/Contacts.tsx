...
const Contacts = () => {
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    setResult("Sending....");
    const formData = new FormData(event.currentTarget); // Use `currentTarget` for type safety
  ...
  return (
    <div id="contact" className="w-full max-w-2xl mx-auto p-10 mt-32 mb-32">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-20 text-center">Contact Me</h1>
